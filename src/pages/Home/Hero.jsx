...
const Hero = () => {
  ...
  return (
    <section className="relative w-full md:h-screen overflow-hidden">
      <Slider {...settings}>
        <div className="bg-hero-image-1 bg-cover bg-center w-full h-[80vh] md:h-screen"></div>
        <div className="bg-hero-image-2 bg-cover bg-center w-full h-[80vh] md:h-screen"></div>
        <div className="bg-hero-image-3 bg-cover bg-center w-full h-[80vh] md:h-screen"></div>
      </Slider>
      <div
